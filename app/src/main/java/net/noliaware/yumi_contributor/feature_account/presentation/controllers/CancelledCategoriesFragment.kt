...
class CancelledCategoriesFragment : Fragment() {
    ...
    private fun collectFlows() {
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.cancelledCategoriesEventsHelper.eventFlow.flowWithLifecycle(lifecycle)
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            viewModel.cancelledCategoriesEventsHelper.stateFlow.flowWithLifecycle(lifecycle)
                .collect { vmState ->
                    when (vmState) {
