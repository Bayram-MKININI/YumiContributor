...
class CategoryView(context: Context, attrs: AttributeSet?) : ViewGroup(context, attrs) {

    private lateinit var countTextView: TextView
    private lateinit var iconImageView: ImageView
    private lateinit var titleTextView: TextView

    data class CategoryViewAdapter(
        val count: Int = 0,
        val iconName: String?,
        val title: String = ""
    )
    ...
    fun fillViewWithData(categoryViewAdapter: CategoryViewAdapter) {
        countTextView.text = categoryViewAdapter.count.toString()
        iconImageView.setImageResource(context.drawableIdByName(categoryViewAdapter.iconName))
        titleTextView.text = categoryViewAdapter.title
    }
